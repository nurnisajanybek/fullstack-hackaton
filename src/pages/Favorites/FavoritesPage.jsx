...
<Box>
      ...
      <div >
        ...
        <img className="img-fav" src="http://34.123.240.158/media/place/%D0%B7%D0%B5%D1%80%D0%BD%D0%BE.jpg" alt="" />
          <h3 className="div-fav">{fav_hotel?.name}</h3>
      </div>
